...
function getDisplayTimestamp(script: UploadedScript): string {
    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {scripts.map((s) => (
            (() => {
              const displayTimestamp = getDisplayTimestamp(s);
              return (
            <div
              key={s.id}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 text-xs text-text-muted">
                      ...
                      <span>
                        {displayTimestamp ? formatDistanceToNow(new Date(displayTimestamp), { addSuffix: true }) : ""}
                      </span>
                    </div>
